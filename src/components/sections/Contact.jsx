    ...
    const handleSubmit = (e) =>{
        ...
        emailjs
            .sendForm(
                ...
                import.meta.env.VITE_SERVICE_ID, e.target, 
            ...
            <RevealOnScroll>
                <div className="px-4 w150">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-yellow-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246, 0.4)]">
                            Send Message
                        </button>
                    </form>
                </div>
